...
public class StatusBarUtil {
    ...
    public static void forNightStatusBar(Activity activity, int colorFor4_4) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (fakeStatusBarView != null) {
                ...
                fakeStatusBarView.setBackgroundColor(calculateStatusColor(colorFor4_4, 0));
            } else {
                decorView.addView(createStatusBarView(activity, colorFor4_4, 0));
            }
